...
export interface BoundKDFOps {
    readonly extract: (salt: Uint8Array) => (ikm: Uint8Array) => Promise<Either<Error, Uint8Array>>
    readonly expand: (
        prk: Uint8Array
    ) => (info: Uint8Array) => (length: number) => Promise<Either<Error, Uint8Array>>
    readonly derive: (
        salt: Uint8Array,
        ikm: Uint8Array,
        info: Uint8Array,
