...
export interface PRNGOps {
    readonly randomBytes: (numBytes: number) => Either<Error, Uint8Array>
    readonly nonce: (numBytes: number) => Either<Error, Uint8Array>
    readonly seed: (numBytes: number) => Either<Error, Uint8Array>
}
