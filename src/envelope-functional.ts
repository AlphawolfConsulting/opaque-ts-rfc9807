...
export const storeEnvelope = curry4(
  async (
    ...
    try {
      ...
      const maskingKeyResult = await expandWithPwd(
      ...
      const exportKeyInfo = new Uint8Array([...envelope_nonce, ...new Uint8Array(LABELS.ExportKey)])
      ...
      const { private: _client_private_key, public: client_public_key } = keyPairResult.unsafeCoerce()
