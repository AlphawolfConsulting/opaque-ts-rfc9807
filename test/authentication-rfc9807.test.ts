...
describe('Authentication RFC 9807 Compliance', () => {
    ...
    describe('CreateCredentialRequest (KE1)', () => {
        ...
        it('should create different KE1 messages for same password', async () => {
            ...
            expect(ke1_1.ke1.auth_init.client_keyshare).not.toEqual(
                ke1_2.ke1.auth_init.client_keyshare
            )
        })
    })
    ...
    describe('Full Authentication Flow', () => {
        it('should complete client-server authentication flow', async () => {
            ...
            const credRespResult =
                await authOps.createCredentialResponse(ke1)(server_public_key)(mockEnvelope)(
                    oprf_key
                )
            ...
            const recoverResult =
                await authOps.recoverCredentials(password)(blind)(ke2)(server_identity)(
                    client_identity
                )(mockDeriveKeyPair)
    ...
    describe('Message Structure Validation', () => {
        ...
        it('should have correct credential response structure', async () => {
            ...
            const result =
                await authOps.createCredentialResponse(ke1)(server_public_key)(envelope)(oprf_key)
            expect(result.isRight()).toBe(true)
    ...
    describe('Error Handling', () => {
        it('should handle empty password', async () => {
            ...
            const result =
                await authOps.createCredentialRequest(emptyPassword)(mockGenerateKeyshare)
