...
import { constructPreamble, computeTripleDHIKM, deriveKeys, create3DHOps } from '../src/3dh-functional.js'
...
describe('3DH RFC 9807 Compliance', () => {
  ...
  describe('Bound 3DH Operations', () => {
    ...
    it('should work through bound operations interface', async () => {
      ...
      const preamble = ops.constructPreamble(context, client_identity, ke1, server_identity, ke2)
